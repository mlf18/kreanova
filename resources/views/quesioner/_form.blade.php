	...
	<div class="container">
		<div class="row">
				...
				<div class="form-group">
					...
					{!! Form::text('bahan_lokal', old('bahan_lokal'), ['class'=>'form-control', 'placeholder' => 'Masukkan Nama']) !!}
					...
					{!! Form::text('kapasitas_produksi', old('kapasitas_produksi'), ['class'=>'form-control', 'placeholder' => 'Masukkan Nama']) !!}
					...
					{!! Form::text('tenaga_kerja', old('tenaga_kerja'), ['class'=>'form-control', 'placeholder' => 'Masukkan Nama']) !!}
				</div>
				<div class="form-group">
					<hr>
					...
					{!! Form::text('prospek_tempat', old('prospek_tempat'), ['class'=>'form-control', 'placeholder' => 'Masukkan Nama']) !!}
					{!! Form::label('prospek_cara', 'Bagaimana caranya ? ') !!}
					{!! Form::text('prospek_cara', old('prospek_cara'), ['class'=>'form-control', 'placeholder' => 'Masukkan Nama']) !!}
					{!! Form::label('biaya_produksi', 'Bagaimana caranya ? ') !!}
					{!! Form::text('biaya_produksi', old('biaya_produksi'), ['class'=>'form-control', 'placeholder' => 'Masukkan Nama']) !!}
					{!! Form::label('omset', 'Bagaimana caranya ? ') !!}
					{!! Form::text('omset', old('omset'), ['class'=>'form-control', 'placeholder' => 'Masukkan Nama']) !!}
					...
					{!! Form::text('asal_bahan', old('asal_bahan'), ['class'=>'form-control', 'placeholder' => 'Masukkan Nama']) !!}
					{!! Form::label('quantity_bahan', 'Banyak tidaknya ketersedian bahan baku untuk produksi temuan/inovasi?') !!}
					{!! Form::text('quantity_bahan', old('quantity_bahan'), ['class'=>'form-control', 'placeholder' => 'Masukkan Nama']) !!}
					...
					{!! Form::text('orientasi', old('orientasi'), ['class'=>'form-control', 'placeholder' => 'Masukkan Nama']) !!}	 
				</div>
