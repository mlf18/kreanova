 ...
 <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ url ('') }}">Krenova 2018 | Laravel 5</a>
            </div>
            <!-- /.navbar-header -->
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="{{ route('pengusul.index') }}">Inventor</a>
                                </li>
                                <li>
                                    <a href="{{ route('proposals.index') }}">Proposal</a>
                                </li>
                                <li>
                                    <a href="{{ route('bupati.index') }}">Kuesioner Kabupaten / Kota</a>
                                </li>
                                <li>
                                    <a href="{{ route('role.index') }}">Rule</a>
                                </li>
                                <li>
                                    <a href="{{ route('permission.index') }}">Hak Akses</a>
                                </li>
