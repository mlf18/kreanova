	...
	<div class="container">
		<div class="row">
				...
				<div class="form-group">
					...
					{!! Form::text('nama', null, ['class'=>'form-control', 'placeholder' => 'jelaskan secara spesifik dalam Rp.      dan ']) !!}
				</div>
				<div class="form-group">
					<hr>
					...
					{!! Form::text('nama', null, ['class'=>'form-control', 'placeholder' => 'jelaskan dengan singkat']) !!}
				</div>
				<div class="form-group">
					<hr>
					<h4>MoU/KERJASAMA</h4>
					...
					{!! Form::text('nama', null, ['class'=>'form-control', 'placeholder' => 'Lengkapi/lampirkan dengan bukti']) !!}
				</div>
				<div class="form-group">
					<hr>
					<h4>PAMERAN / LOMBA</h4>
					{!! Form::label('nama', 'a)	Adakah penyelenggaraan lomba Krenova tingkat kab/kota?  ') !!}
					{!! Form::text('nama', null, ['class'=>'form-control', 'placeholder' => 'jelaskan']) !!}
				...
				<div class="form-group">
					...
					{!! Form::text('nama', null, ['class'=>'form-control', 'placeholder' => ' diisi oleh tim Bappeda Provinsi']) !!}
